...
#load the data
data = pd.read_csv('594etransactions.csv')
...
plt.text(15.39, 380, 'Ethereum Merge', verticalalignment = 'center_baseline', c='blue')
...
plt.savefig('594e_profit_figure.png', dpi = 300)
plt.show()
