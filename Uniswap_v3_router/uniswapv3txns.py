...
#load the data
data = pd.read_csv('uniswapv3txn.csv')
...
plt.text(15.39, 11000, 'Ethereum Merge', verticalalignment = 'center_baseline', c='blue')
plt.xlabel('Block Number (in millions)')
plt.ylabel('Transactions per 1,000 Blocks')

#add a quadratic regression line if blockgroup is less than 15.537
...
plt.savefig('uniswap_v3_txn_figure.png', dpi = 300)
plt.show()
