...
import delimited "uniswapv3.csv", clear
...
save "uniswapv3txn.dta", replace
export delimited using "uniswapv3txn.csv", replace 
...
outreg2 using uniswap_v3_reg, replace

reg error_rate block0 block0_2 interaction interaction_2 merge, robust
outreg2 using uniswap_v3_reg, excel
