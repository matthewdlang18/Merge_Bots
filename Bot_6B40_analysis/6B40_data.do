...
import delimited 6B40token.csv, clear 
...
save 6B40profit.dta, replace
export delimited using 6B40profit.csv, replace 

clear


*Run regression discontinuity
import delimited 6B40txn.csv, clear 
gen txn=1
gen blockgroup=floor(blocknumber/1000)
...
merge m:m blockgroup using 6B40profit.dta
...
outreg2 using 6B40_reg, replace

reg error_rate block0 block0_2 interaction interaction_2 merge, robust
outreg2 using 6B40_reg, excel


drop _merge

save 6B40transactions.dta, replace
export delimited using 6B40transactions.csv, replace 
