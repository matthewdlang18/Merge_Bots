...
addresses = ["0x00000000003b3cc22aF3aE1EAc0440BcEe416B40"]
...
for address in addresses:
    ...
    while current_block < end_block:
        # set the url
        url = "https://api.etherscan.io/api?module=account&action=tokentx&address=" + address + "&startblock=" + str(current_block) + "&endblock=" + str(current_block + block_range) + "&sort=asc&apikey=" + api_key
