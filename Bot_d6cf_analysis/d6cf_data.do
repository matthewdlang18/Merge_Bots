...
import delimited d6cf_token.csv, clear

gen txn=1
*merge with block times for blocks 15000000 to 16000000
merge m:m blocknumber using "blocktimes_simple.dta"
...
save d6cf_txn.dta, replace
export delimited using d6cf_txn.csv, replace 
